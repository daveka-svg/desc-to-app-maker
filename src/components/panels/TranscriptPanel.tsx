      ...
      <div className="flex items-center justify-between px-5 py-2 bg-card border-b border-border-light shrink-0">
        ...
        <div className="flex items-center gap-1.5">
          <button
            onClick={handleCopy}
            disabled={!transcript}
            className="flex items-center gap-[5px] px-3.5 py-1.5 bg-sand border border-border rounded-md text-[13px] font-semibold text-bark cursor-pointer hover:bg-sand-dark disabled:opacity-40 disabled:cursor-default"
          >
      ...
      <div className="flex-1 overflow-y-auto p-6">
        {!transcript && !isRecording ? (
          <div className="max-w-[720px] text-sm text-text-muted py-12 text-center">
            ...
            <p>Start recording from the <strong className="text-bark">Context</strong> tab, or paste a transcript below to get started.</p>
          </div>
        ) : null}
        ...
        <textarea
          ...
          placeholder={isRecording ? 'Transcript will appear here as you record...' : 'Paste or type transcript here...'}
          value={transcript}
