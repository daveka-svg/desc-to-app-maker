export const GENERAL_CONSULT_PROMPT_VERSION = "direct-template-v6" as const;

export const DEFAULT_GENERAL_CONSULT_TEMPLATE_PROMPT = `You are doing AI scribe notes for a vet. Read the transcript of the consultation and summaries it.
